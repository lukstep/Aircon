...
class Client {
  ...
  public:
    ...
    static void packetRecvCallback(void* ntp_ptr, struct udp_pcb* udp,
                                   struct pbuf* buffer, const ip_addr_t* addres,
                                   uint16_t port);
    static void serverDnsFoundCallback(const char* hostname,
